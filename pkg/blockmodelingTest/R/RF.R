...
#' @param k The number of randomized networks for the estimation of the expected value of a criterion function. It has to be as high as possible.
...
#' @references Cugmas, M., Ziberna, A., & Ferligoj, A. (2019). Mechanisms Generating Asymmetric Core-Cohesive Blockmodels. Metodoloski Zvezki, 16(1), 17-41.

RF <- function(res, k = 10, loops = TRUE){
